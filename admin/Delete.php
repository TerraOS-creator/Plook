...
<h1>Delete:</h1>
<div class="garis">
<a href="DeleteController.php?id=<?php echo "User";?>" class="wrapper"><h2>User</h2></a>
<a href="DeleteController.php?id=<?php echo "Hotel";?>" class="wrapper"><h2>Hotel</h2></a>
</div>
<div class="garis">
<a href="DeleteController.php?id=<?php echo"Transportation";?>" class="wrapper"><h2>Transportation</h2></a>
<a href="DeleteController.php?id=<?php echo"Atraksi";?>" class="wrapper"><h2>Atraksi</h2></a>
</div>
</div>
